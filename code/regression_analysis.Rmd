...
c_loss_selected <- "H" #edit to change which soil carbon loss scenario is used for following graphs. options are L, H
...
read_csv("int_data/luc_co2_country_crop.csv") %>%  #read in kg co2/ha carbon loss for crops for all countries; need to filter to just countries included
  ...
  write_csv("results/tables/tableS9_LUC_by_crop.csv")
```
